        ...
        @foreach ($livres as $livre)
            <div class="rounded-lg border border-gray-200 bg-white p-6 shadow-sm dark:border-gray-700 dark:bg-gray-800">
              <div class="h-56 w-full">
                <a href="#">
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class=" mx-auto h-full stroke-calm-400">
              ...
              <div class="pt-6">
                <div class="mb-4 flex items-center justify-between gap-4">
                  <span class="me-2 rounded bg-secondary-100 px-2.5 py-0.5 text-xs font-medium text-secondary-800 dark:bg-secondary-900 dark:text-black"> Up to 35% off </span>
                ...
                <a href="#" class="text-lg font-semibold leading-tight text-gray-900 hover:underline dark:text-white">{{ $livre->nomlivre }}</a>
                ...
                <div class="mt-4 flex items-center justify-between gap-4">
                  ...
                  <a href="{{ route('livres.show', $livre->id) }}" type="button" class="cursor-pointer  inline-flex mx-auto w-full  items-center justify-center rounded-lg bg-secondary-700 px-5 py-2.5 text-sm font-medium text-white hover:bg-secondary-800 focus:outline-none focus:ring-4  focus:ring-secondary-300 dark:bg-secondary-600 dark:hover:bg-secondary-700 dark:focus:ring-secondary-800">
